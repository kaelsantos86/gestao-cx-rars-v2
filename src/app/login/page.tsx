      ...
      <div style={{ maxWidth: 980, margin: '32px auto 0' }}>
        ...
        <div className="grid grid2">
          <section className="card">
            <p className="eyebrow">Já tenho acesso</p>
            <h2>Entrar</h2>
            <form action={login}>
              <div className="field">
          ...
          <section className="card">
            ...
            <p className="muted" style={{ fontSize: 14 }}>
              Use este cadastro apenas para a conta gerencial. Os colaboradores continuarão acessando os formulários pelos links seguros de cada módulo.
            </p>
            <form action={signUp}>
              <div className="field">
